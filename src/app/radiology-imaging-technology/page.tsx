            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10 flex flex-col md:flex-row gap-12 items-center">
                ...
                <div className="md:w-1/2 w-full">
                    <div className="relative rounded-3xl overflow-hidden aspect-video shadow-2xl border-4 border-white bg-[#0b6d41] flex items-center justify-center group">
                        ...
                        <ScanLine className="w-24 h-24 text-white/80 group-hover:scale-110 transition-transform duration-700" />
                        <span className="absolute bottom-6 left-6 font-bold text-xl letter-spacing-wide text-white">Radiology & Imaging</span>
                    </div>
                </div>
            </div>
            {/* Background elements */}
    ...
    return (
        <section className="py-24 max-w-7xl mx-auto px-4 text-center">
            ...
            <div className="grid md:grid-cols-4 gap-6">
                {[
                    { title: "X-ray & CT Lab (Tieup Hospitals)", color: "bg-[#0b6d41]", text: "text-white", desc: "Advanced X-ray and CT scan equipment." },
                    { title: "MRI Suite (Tieup Hospitals)", color: "bg-[#ffde59]", text: "text-[#0b6d41]", desc: "High-field MRI machines and training." },
                    { title: "Ultrasound Lab (Tieup Hospitals)", color: "bg-[#163a4a]", text: "text-white", desc: "Latest ultrasound and Doppler systems." },
