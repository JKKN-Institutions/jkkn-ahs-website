            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10 flex flex-col md:flex-row gap-12 items-center">
                ...
                <div className="md:w-1/2 w-full">
                    <div className="relative rounded-3xl overflow-hidden aspect-video shadow-2xl border-4 border-white bg-[#0b6d41] flex items-center justify-center group">
                        ...
                        <Droplet className="w-24 h-24 text-white/80 group-hover:scale-110 transition-transform duration-700" />
                        <span className="absolute bottom-6 left-6 font-bold text-xl letter-spacing-wide text-white">Dialysis Technology</span>
                    </div>
                </div>
            </div>
            {/* Background elements */}
        ...
        <section className="py-24 bg-white text-center">
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="grid md:grid-cols-4 gap-6">
                    {[
                        { title: "Hemodialysis Unit (Tieup Hospitals)", color: "bg-[#0b6d41]", text: "text-white", desc: "Multi-station hemodialysis machines and monitors." },
                        { title: "PD Training Lab (Tieup Hospitals)", color: "bg-[#ffde59]", text: "text-[#0b6d41]", desc: "CAPD and APD equipment for peritoneal dialysis." },
                        { title: "Water Treatment Plant (Tieup Hospitals)", color: "bg-[#163a4a]", text: "text-white", desc: "RO system and water quality testing facility." },
